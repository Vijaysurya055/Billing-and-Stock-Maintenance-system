...
main.title("Jeyam Department Store")
main.resizable(0, 0)
...
def emp_shortcut(event):
    emp()

def adm_shortcut(event):
    adm()

# Bind shortcut keys
main.bind('<KeyPress-e>', emp_shortcut)  # 'E' for employee
main.bind('<KeyPress-a>', adm_shortcut)  # 'A' for admin
